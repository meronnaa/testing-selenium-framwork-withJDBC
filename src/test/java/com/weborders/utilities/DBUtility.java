...
public class DBUtility {
    ...
    public static void establishConnection(DBType dbType) throws SQLException {
        switch (dbType){
            ...
            break;
//            case MYSQL:
//                connection = DriverManager.getConnection(ConfigurationReader.getProperty("oracledb.url"),===If we had some other database we can say these but now we don't have it
//                        ConfigurationReader.getProperty("oracledb.user"),
//                        ConfigurationReader.getProperty("oracledb.password"));
            default:
                return;
